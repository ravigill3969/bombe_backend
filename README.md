...
📚 **Backend documentation lives in [`docs/`](./docs/README.md)** — architecture, the HTTP/WebSocket API reference, service internals, the data model, and configuration.
...
![Bombe Architecture](./bombe-archi.excalidraw.png)
